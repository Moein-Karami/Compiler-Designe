...
func_call
	: LPAR func_call RPAR
	| {System.out.println("MethodCall");} var DOT? LPAR func_input? RPAR ext?
	;
...
assigment
	...
	| (var  EQUAL expr {System.out.println("Operator : " + "=");} expr_prime expr_prime
       	...
       	| LPAR expr RPAR expr_prime) (PLUS_PLUS {System.out.println("Operator : " + "++");} | MINUS_MINUS {System.out.println("Operator : " + "--");})
	| ternary_condition expr_prime (PLUS_PLUS {System.out.println("Operator : " + "++");} | MINUS_MINUS {System.out.println("Operator : " + "--");})
	;
...
expr_prime
	...
	| expr {System.out.println("Operator : " + "++");} PLUS_PLUS expr_prime expr_prime
    | expr {System.out.println("Operator : " + "--");} MINUS_MINUS expr_prime expr_prime
    |
	;
...
ternary_prime
	: expr_prime QUESTION_MARK expr COLON expr ternary_prime
